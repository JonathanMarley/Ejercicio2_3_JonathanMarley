...
public class Agregar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imagen = (ImageView) findViewById(R.id.tomarfotos);
        ...
        Button btnImagenes = (Button) findViewById(R.id.btnImagen);
    ...
    private void permisos() {
        if(ContextCompat.checkSelfPermission(getApplicationContext(), android.Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED
            ...
            ActivityCompat.requestPermissions(Agregar.this, new String[]{ android.Manifest.permission.CAMERA, Manifest.permission.WRITE_EXTERNAL_STORAGE }, PETICION_ACCESO_CAM);
        }else{
            tomarFotos();
        }
    }
